...
int main() {
    ...
    DNAseq dna6;
    cout << "HANDE DEBUG1: " << dna6 + dna4   << endl;
    cout << "HANDE DEBUG2: " << dna6 + dna4 + dna2*2  << endl;
    cout << "HANDE DEBUG3: " << dna6 + dna4 + dna2*2 - dna2 << endl;
    cout << "HANDE DEBUG4: " << dna6 + dna4 + dna2*2 - dna2 + (C + dna4)<< endl;
    cout << "HANDE DEBUG5: " << (dna6 - dna6*4) << endl;
    cout << "HANDE DEBUG6: " << dna6 + dna4 + dna2*2 - dna2 + (C + dna4) + (dna6 - dna6*4) << endl;
